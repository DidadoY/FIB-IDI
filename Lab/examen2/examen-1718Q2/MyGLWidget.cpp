...
void MyGLWidget::escogerPat2(){
  makeCurrent();
  if (patrrrr == 2) patrrrr = 0;
  else patrrrr = 2;
  update();
}

void MyGLWidget::escogerPat3(){
  makeCurrent();
  if (patrrrr == 3) patrrrr = 0;
  else patrrrr = 3;
  update();
}

void MyGLWidget::escogerPat4(){
  makeCurrent();
  if (patrrrr == 4) patrrrr = 0;
  else patrrrr = 4;
  update();
}
...
void MyGLWidget::modelTransformModel (float anglepat, int escalapat)
{
  glm::mat4 TG(1.f);  // Matriu de transformació
  TG = glm::rotate(TG, anglepat, glm::vec3(0, 1, 0));
  TG = glm::translate(TG, glm::vec3(8, 0, 8));
  TG = glm::scale(TG, glm::vec3(escalapat*escalaModel,escalapat*escalaModel,escalapat*escalaModel));
...
void MyGLWidget::projectTransform ()
{
  ...
  Proj = glm::perspective(float(M_PI/3.0), 1.0f, radiEsc, 20.0f*radiEsc);
...
void MyGLWidget::viewTransform ()
{
  ...
  View = glm::translate(glm::mat4(1.f), glm::vec3(x, y, z));
